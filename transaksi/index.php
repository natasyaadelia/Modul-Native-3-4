<?php
    include '../koneksi.php';
        ...
        INNER JOIN petugas ON peminjaman.id_petugas = petugas.id_petugas INNER JOIN detail_pinjam ON peminjaman.id_pinjam = detail_pinjam.id_pinjam
            ...
            <tr>
                ...
                <td>
                    ...
                    if (@$p['status'] == "Dipinjam") {
                        echo '<h5><span class="badge badge-info"> ipinjam</span></h5>';
                    } else {
